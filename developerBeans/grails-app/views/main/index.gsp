...
${post.user.displayName}
                            <small><g:formatDate format="dd MMM, yyyy" date="${post.createdOn}"/> </small>
                          </h5>
...
${post.content}
                        ...
                        <g:each in="${post.getPostComments()}" var="postComment" status="j">
                          <div class="stream-respond">
                            <div class="media stream">
                              ...
                              <div class="media-body">
                                <div class="stream-headline">
                                  <h5 class="stream-author">
${com.developerbeans.user.User.findByUserId(postComment.userId)?.displayName}
                                    <small><g:formatDate format="dd MMM, yyyy" date="${postComment.postedOn}"/> </small>
                                  </h5>
                                  <div class="stream-text">
