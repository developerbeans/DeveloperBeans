			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="category" title="${message(code: 'tag.category.label', default: 'Category')}" />
					
						<g:sortableColumn property="tagVersion" title="${message(code: 'tag.tagVersion.label', default: 'Tag Version')}" />
				...
				<g:each in="${tagInstanceList}" status="i" var="tagInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: tagInstance, field: "tagVersion")}</td>
