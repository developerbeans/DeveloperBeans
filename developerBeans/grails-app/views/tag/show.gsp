	...
	<body>
		...
		<div id="show-tag" class="content scaffold-show" role="main">
			...
			<ol class="property-list tag">
				...
				<g:if test="${tagInstance?.category}">
				<li class="fieldcontain">
					<span id="category-label" class="property-label"><g:message code="tag.category.label" default="Category" /></span>
					
						<span class="property-value" aria-labelledby="category-label"><g:fieldValue bean="${tagInstance}" field="category"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${tagInstance?.tagVersion}">
				<li class="fieldcontain">
					<span id="tagVersion-label" class="property-label"><g:message code="tag.tagVersion.label" default="Tag Version" /></span>
					
						<span class="property-value" aria-labelledby="tagVersion-label"><g:fieldValue bean="${tagInstance}" field="tagVersion"/></span>
