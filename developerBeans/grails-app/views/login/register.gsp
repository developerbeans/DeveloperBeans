    ...
    <div class="container">
      <div class="row">
        <div class="module module-login span4 offset4">
          ...
          <g:form controller="login" action="saveUser" class="form-vertical" type="POST">
...
${flash.message}
              ...
              <div class="control-group">
                <div class="controls row-fluid">
                  <input class="span12" type="text" id="displayName" name="displayName" placeholder="Display Name">
                </div>
              </div>
              <div class="control-group">
                <div class="controls row-fluid">
              ...
              <div class="control-group">
                <div class="controls row-fluid">
                  <input class="span12" type="password" id="confirmPassword" name="confirmPassword" placeholder="Confirm Password">
                </div>
              </div>
            </div>
            <div class="module-foot">
              <div class="control-group">
                <div class="controls clearfix">
                  <input type="submit" onclick="return validateNewUserDetails()" class="btn btn-primary pull-right" value="Register"/>
                </div>
              </div>
            </div>
          </g:form>
